...
local default_settings = {
	...
	commands = {
		{ cmd = 'hme' , description = 'Лечение самого себя' ,  text = '/me достаёт лекарство из кейса, внимательно смотрит на него и принимает.&/heal {my_id} {price_heal}' , arg = '' , enable = true, waiting = '1.200', deleted = false  },
		...
		{ cmd = 'cure' , description = 'Поднять игрока из стадии' ,  text = '/me наклоняется над человеком, и прощупывает его пульс на сонной артерии&/cure {arg_id}&/do Пульс отсутствует.&/me начинает делать человеку непрямой массаж сердца, время от времени проверяя пульс&/do Спустя несколько минут сердце человека началось биться.&/do Человек пришел в сознание.&/todo Отлично*улыбаясь' , arg = '{arg_id}' , enable = true , waiting = '1.200', deleted = false  },
		{ cmd = 'hl' , description = 'Обычное лечение игрока' , text = '/me достаёт из мед.кейса необходимое лекарство и передаёт его человеку напротив. /todo Принимайте, это поможет вам! /heal {arg_id} {price_heal} /n {get_nick({arg_id})}, примите предложение в /offer, чтобы вылечиться!', arg = '{arg_id}' , enable = true, waiting = '1.200', deleted = false   },
		{ cmd = 'hla' , description = 'Лечение охранника игрока' ,  text = '/me достаёт из своего мед.кейса лекарство и передаёт его человеку напротив&/todo Давайте своему охраннику это лекарство, оно ему поможет*улыбаясь&/healactor {arg_id} {price_actorheal}&/n {get_nick({arg_id})}, примите предложение в /offer чтобы вылечить охранника!' , arg = '{arg_id}' , enable = true , waiting = '1.200', deleted = false  },
		{ cmd = 'hlb' , description = 'Лечение игрока от наркозависимости' ,  text = '/me достаёт из своего мед.кейса таблетки от наркозависимости и передаёт их пациенту напротив&/todo Принимайте эти таблетки, и в скором времени Вы излечитесь от наркозависимости*улыбаясь&/healbad {arg_id}&/n {get_nick({arg_id})}, примите предложение в /offer чтобы вылечиться!' , arg = '{arg_id}' , enable = true , waiting = '1.200', deleted = false  },		
		{ cmd = 'mt' , description = 'Мед.оcмотр для военного билета' ,  text = 'Хорошо, сейчас я проведу вам мед.осмотр для получения военного ... &... билета по стану здоровья, но шанс на успех всего 1 процент!&/mticket {arg_id} {price_mticket}&/n {get_nick({arg_id})}, примите предложение в /offer для начала мед.осмотра!' , arg = '{arg_id}' , enable = true, waiting = '1.200', deleted = false  },
		{ cmd = 'osm' , description = 'Полный мед.осмотр игрока' ,  text = 'Хорошо, сейчас я проведу вам мед.осмотр.&Дайте мне вашу мед.карту для проверки.&/n {get_nick({arg_id})}, введите /showmc {my_id} чтобы показать мне мед.карту.&{pause}&/me достаёт из мед.кейса стерильные перчатки и надевает их на руки&/do Перчатки на руках.&/todo Начнём мед.осмотр*улыбаясь. /medcheck {arg_id} {price_medosm}&/n {get_nick({arg_id})}, примите предложение в /offer для продолжения мед.осмотра!&/n Пока вы не примите предложение, мы не сможем начать&{pause}&И так...&Сейчас я проверю ваше горло, откройте рот и высуните язык.&/n Используйте /me открыл(-а) рот чтоб мы продолжили&{pause}&/me достаёт из мед.кейса фонарик и включив его осматривает горло человека напротив&Хорошо, можете закрывать рот, сейчас я проверю ваши глаза.&/me проверяет реакцию человека на свет, посветив фонарик в глаза&/do Зрачки глаз обследуемого человека сузились.&/todo Отлично*выключая фонарик и убирая его в мед.кейс&Такс, сейчас я проверю ваше сердцебиение, поэтому приподнимите верхную одежду!&/n {get_nick({arg_id})}, введите /showtatu чтобы снять одежду по РП&{pause}&/me достаёт из мед.кейса стетоскоп и приложив его к груди человека проверяет сердцебиение&/do Сердцебиение в районе 65 ударов в минуту.&/todo С сердцебиением у вас все в порядке*убирая стетоскоп обратно в мед.кейс&/me снимает со своих рук использованные перчатки и выбрасывает их&Ну что-ж я могу вам сказать...&Со здоровьем у вас все в порядке, вы свободны!' , arg = '{arg_id}', enable = true, waiting = '1.200', deleted = false} , 
		{ cmd = 'pilot' , description = 'Мед.осмотр для пилотов' ,  text = 'Хорошо, сейчас я проведу вам мед.осмотр для пилотов.&/medcheck {arg_id} {price_medosm}&/n {get_nick({arg_id})}, примите предложение в /offer для продолжения мед.осмотра!&/n Пока вы не примите предложение, мы не сможем начать!&{pause}&И так...&/me достаёт из мед.кейса стерильные перчатки и надевает их на руки&/do Перчатки на руках.&/todo Начнём мед.осмотр*улыбаясь.&Сейчас я проверю ваше горло, откройте рот и высуните язык.&/me достаёт из мед.кейса фонарик и включив его осматривает горло человека напротив&Хорошо, можете закрывать рот, сейчас я проверю ваши глаза.&/me проверяет реакцию человека на свет, посветив фонарик в глаза&/do Зрачки глаз обследуемого человека сузились.&/todo Отлично*выключая фонарик и убирая его в мед.кейс&Такс, сейчас я проверю ваше сердцебиение, поэтому приподнимите верхную одежду!&/me достаёт из мед.кейса стетоскоп и приложив его к груди человека проверяет сердцебиение&/do Сердцебиение в районе 65 ударов в минуту.&/todo С сердцебиением у вас все в порядке*убирая стетоскоп обратно в мед.кейс&/me снимает со своих рук использованные перчатки и выбрасывает их&Ну что-ж я могу вам сказать, со здоровьем у вас все в порядке, вы свободны!' , arg = '{arg_id}' , enable = true, waiting = '1.200' , deleted = false },
		{ cmd = 'gd' , description = 'Экстренный вызов (/godeath)' ,  text = '/me достаёт телефон и открывает базу данных {fraction_tag}. /me внимательно изучает информацию и, получив все данные, направляется к месту экстренного вызова. /godeath {arg_id}' , arg = '{arg_id}' , enable = true, waiting = '1.200' , deleted = false  },
		{ cmd = 'medin' , description = 'Оформление игроку мед.страховки' ,  text = 'Для оформления мед.страховки Вам необходимо оплатить определнную cумму.&Стоимость зависит от срока действия будущей мед.страховки.&На 1 неделю - $4ОО.ООО. На 2 недели - $8ОО.ООО. На 3 недели - $1.2ОО.ООО.&И так, скажите, на какой срок Вам оформить мед.страховку?&{pause}&/me достаёт из своего мед.кейса пустой бланк мед.страховки, ручку и печать {fraction_tag}&/me открывает бланк мед.страховки и начинает его заполнять, затем ставит печать {fraction_tag}&/me полностю заполнив бланк мед.страховки убирает ручку и печать обратно в свой мед.кейс&/givemedinsurance {arg_id}&/todo Вот ваша мед.страховка, берите*протягивая бланк с мед.страховкой человеку напротив себя&/n {get_nick({arg_id})}, примите предложение в /offer для получения' , arg = '{arg_id}' , enable = true, waiting = '1.200' , deleted = false  },
		{ cmd = 'med' , description = 'Оформление игроку мед.карты' ,  text = 'Оформление мед. карты платное и зависит от её срока действия! Мед. карта на 7 дней - ${price_med7}, на 14 дней - ${price_med14}. Мед. карта на 30 дней - ${price_med30}, на 60 дней - ${price_med60}. Скажите, на какой срок оформить мед. карту? {show_medcard_menu} Хорошо, приступим к оформлению. /me достаёт из своего мед.кейса пустую мед.карту, ручку и печать {fraction_tag}. /me открывает пустую мед.карту и начинает её заполнять, затем ставит печать {fraction_tag}. /me, заполнив мед.карту, убирает ручку и печать обратно в мед.кейс. /todo Вот ваша мед.карта, берите. *протягивая заполненную мед.карту человеку напротив себя. /medcard {arg_id} {get_medcard_status} {get_medcard_days} {get_medcard_price}. /n {get_nick({arg_id})}, примите предложение в /offer для получения медкарты.' , arg = '{arg_id}' , enable = true, waiting = '1.200' , deleted = false  },
		{ cmd = 'recept' , description = 'Выдача игроку рецептов' ,  text = 'Стоимость одного рецепта составляет ${price_recept}&Скажите сколько Вам требуется рецептов, после чего мы продолжим.&/n Внимание! В течении часа выдаётся максимум 5 рецептов!&{show_recept_menu}&Хорошо, сейчас я выдам вам рецепты.&/me достаёт из своего мед.кейса бланк для оформления рецептов и начает его заполнять&/me ставит на бланк рецепта печать {fraction_tag}&/do Бланк успешно заполнен.&/todo Вот, держите!*передавая бланк  рецепта человеку напротив&/recept {arg_id} {get_recepts}' , arg = '{arg_id}' , enable = true, waiting = '1.200' , deleted = false },
		{ cmd = 'ant' , description = 'Выдача игроку антибиотиков' ,  text = 'Стоимость одного антибиотика составляет ${price_ant}&Скажите сколько Вам требуется антибиотиков, после чего мы продолжим.&/n Внимание! Вы можете купить от 1 до 20 антибитиков за один раз!&{show_ant_menu}&Хорошо, сейчас я выдам вам антибиотики.&/me открывает свой мед.кейс и достаёт из него пачку антибиотиков, после чего закрывает мед.кейс&/do Антибиотики находятся в руках.&/todo Вот держите, употребляйте их строго по рецепту!*передавая антибиотики человеку напротив&/antibiotik {arg_id} {get_ants}' , arg = '{arg_id}' , enable = true, waiting = '1.200' , deleted = false },
		...
		{ cmd = 'expel' , description = 'Выгнать игрока из больницы' ,  text = 'Вы больше не можете здесь находиться, я выгоняю вас из больницы!&/me схватив человека ведёт к выходу из больницы и закрывает за ним дверь&/expel {arg_id} {expel_reason}' , arg = '{arg_id}' , enable = true , waiting = '1.200' , deleted = false },
	},
	commands_manage = {
...
function load_settings()
    ...
    if not doesFileExist(path) then
		...
		print('[QweDimsHelper] Файл с настройками не найден, использую стандартные настройки!')
    else
        ...
        if file then
			...
			if #contents == 0 then
				settings = default_settings
				print('[QweDimsHelper] Не удалось открыть файл с настройками, использую стандартные настройки!')
			else
				...
				if result then
					...
					print('[QweDimsHelper] Настройки успешно загружены!')
				else
					print('[QweDimsHelper] Не удалось открыть файл с настройками, использую стандартные настройки!')
				end
			end
...
function save_settings()
    ...
    if file then
        ...
        file:close()
		print('[QweDimsHelper] Настройки сохранены!')
        return result
    else
        print('[QweDimsHelper] Не удалось сохранить настройки хелпера, ошибка: ', errstr)
        return false
    end
end
load_settings()
...
local input_med60 = imgui.new.char[256](u8(settings.price.wbook))
...
local tagReplacements = {
	...
	price_wbook = function() return settings.price.wbook end,
	sex = function() 
...
{get_wbook_price} - Получить цену мед.книжки
...
function main()
	...
	if settings.player_info.name_surname == '' or  settings.player_info.fraction == 'Неизвестно' then
		sampAddChatMessage('[QweDimsHelper] {ffffff}Пытаюсь получить ваш /stats поскольку остуствуют данные про вас!', message_color)
		check_stats = true
		sampSendChat('/stats')
	end
	...
	while true do
		...
		if ((os.date("%M", os.time()) == "55" and os.date("%S", os.time()) == "00") or (os.date("%M", os.time()) == "25" and os.date("%S", os.time()) == "00")) then
			if sampGetPlayerColor(tagReplacements.my_id()) == 368966908 then
				sampAddChatMessage('[QweDimsHelper] {ffffff}Через 5 минут будет PAYDAY. Наденьте форму чтобы не пропустить зарплату!', message_color)
				wait(1000)
			end
		end
...
function welcome_message()
	if not sampIsLocalPlayerSpawned() then 
		sampAddChatMessage('[QweDimsHelper] {ffffff}Загрузка хелпера прошла успешно!',message_color)
		sampAddChatMessage('[QweDimsHelper] {ffffff}Для полной загрузки хелпера сначало заспавнитесь (авторизуйтесь на сервер)',message_color)
		repeat wait(0) until sampIsLocalPlayerSpawned()
	end
	sampAddChatMessage('[QweDimsHelper] {ffffff}Здравствуйте Я готов к работе!', message_color)
	show_arz_notify('info', 'QweDimsHelper', "Загрузка хелпера прошла успешно!", 3000)
	if isMonetLoader() or settings.general.bind_mainmenu == nil or not settings.general.use_binds then	
		sampAddChatMessage('[QweDimsHelper] {ffffff}Чтоб открыть меню хелпера введите команду ' .. message_color_hex .. '/hh', message_color)
	elseif hotkey_no_errors and settings.general.bind_mainmenu and settings.general.use_binds then
		sampAddChatMessage('[QweDimsHelper] {ffffff}Чтоб открыть меню хелпера нажмите ' .. message_color_hex .. getNameKeysFrom(settings.general.bind_mainmenu) ..' {ffffff}или введите команду ' .. message_color_hex .. '/hh', message_color)
	else
		sampAddChatMessage('[QweDimsHelper] {ffffff}Чтоб открыть меню хелпера введите команду ' .. message_color_hex .. '/hh', message_color)
	end
end
		...
		if not isActiveCommand then
			...
			if cmd_arg == '{arg}' then
				if arg and arg ~= '' then
					...
					sampAddChatMessage('[QweDimsHelper] {ffffff}Используйте ' .. message_color_hex .. '/' .. chat_cmd .. ' [аргумент]', message_color)
			...
			elseif cmd_arg == '{arg_id}' then
				if isParamSampID(arg) then
					...
					sampAddChatMessage('[QweDimsHelper] {ffffff}Используйте ' .. message_color_hex .. '/' .. chat_cmd .. ' [ID игрока]', message_color)
			...
			elseif cmd_arg == '{arg_id} {arg2}' then
				if arg and arg ~= '' then
					...
					if isParamSampID(arg_id) and arg2 then
						...
						sampAddChatMessage('[QweDimsHelper] {ffffff}Используйте ' .. message_color_hex .. '/' .. chat_cmd .. ' [ID игрока] [аргумент]', message_color)
			...
			elseif cmd_arg == '{arg_id} {arg2} {arg3}' then
				if arg and arg ~= '' then
					...
					if isParamSampID(arg_id) and arg2 and arg3 then
						...
						sampAddChatMessage('[QweDimsHelper] {ffffff}Используйте ' .. message_color_hex .. '/' .. chat_cmd .. ' [ID игрока] [аргумент] [аргумент]', message_color)
				...
				lua_thread.create(function()
					...
					if modifiedText:find('&.+&') then
						if isMonetLoader() and settings.general.mobile_stop_button then
							sampAddChatMessage('[QweDimsHelper] {ffffff}Чтобы остановить отыгровку команды используйте ' .. message_color_hex .. '/stop {ffffff}или нажмите кнопку внизу экрана', message_color)
						...
						elseif not isMonetLoader() and hotkey_no_errors and settings.general.bind_command_stop and settings.general.use_binds then
							sampAddChatMessage('[QweDimsHelper] {ffffff}Чтобы остановить отыгровку команды используйте ' .. message_color_hex .. '/stop {ffffff}или нажмите ' .. message_color_hex .. getNameKeysFrom(settings.general.bind_command_stop), message_color)
						else
							sampAddChatMessage('[QweDimsHelper] {ffffff}Чтобы остановить отыгровку команды используйте ' .. message_color_hex .. '/stop', message_color)
						end
					end
					local lines = {}
					...
					for line_index, line in ipairs(lines) do
						if command_stop then 
							...
							sampAddChatMessage('[QweDimsHelper] {ffffff}Отыгровка команды /' .. chat_cmd .. " успешно остановлена!", message_color) 
							return 
						else
							...
							elseif line == "{pause}" then
								sampAddChatMessage('[QweDimsHelper] {ffffff}Команда /' .. chat_cmd .. ' поставлена на паузу!', message_color)
								command_pause = true
								...
								if not command_stop then
									sampAddChatMessage('[QweDimsHelper] {ffffff}Продолжаю отыгровку команды /' .. chat_cmd, message_color)	
								end					
							else
			...
			sampAddChatMessage('[QweDimsHelper] {ffffff}Дождитесь завершения отыгровки предыдущей команды!', message_color)
		end
	end)
end
function find_and_use_command(cmd, cmd_arg)
	...
	if not check then
		sampAddChatMessage('[QweDimsHelper] {ffffff}Ошибка, не могу найти бинд для выполнения этой команды!', message_color)
		return
	end
end
function initialize_commands()
	...
	sampRegisterChatCommand("stop", function() 
		if isActiveCommand then 
			...
			sampAddChatMessage('[QweDimsHelper] {ffffff}В данный момент нету никакой активной команды/отыгровки!', message_color) 
		end
	end)
	sampRegisterChatCommand("sob", function(arg)
		if not isActiveCommand then
			if isParamSampID(arg) then
				...
				sampAddChatMessage('[QweDimsHelper] {ffffff}Используйте ' .. message_color_hex .. '/sob [ID игрока]', message_color)
			end
			...
			if not isActiveCommand then
				lua_thread.create(function()
					...
					if command_stop then 
						...
						sampAddChatMessage('[QweDimsHelper] {ffffff}Отыгровка команды /spcar успешно остановлена!', message_color) 
						return
					end
	...
	if isParamSampID(id) then 
		...
		if isMonetLoader() or settings.general.bind_fastmenu == nil then
			if not FastMenuPlayers[0] then
				sampAddChatMessage('[QweDimsHelper] {ffffff}Используйте ' .. message_color_hex .. '/hm [ID]', message_color)
			end
		elseif settings.general.bind_fastmenu and settings.general.use_binds and hotkey_no_errors then
			sampAddChatMessage('[QweDimsHelper] {ffffff}Используйте ' .. message_color_hex .. '/hm [ID] {ffffff}или наведитесь на игрока через ' .. message_color_hex .. 'ПКМ + ' .. getNameKeysFrom(settings.general.bind_fastmenu), message_color) 
		else
			sampAddChatMessage('[QweDimsHelper] {ffffff}Используйте ' .. message_color_hex .. '/hm [ID]', message_color)
		end 
	end 
...
function show_leader_fast_menu(id)
	if isParamSampID(id) then
		...
		if isMonetLoader() or settings.general.bind_leader_fastmenu == nil then
			sampAddChatMessage('[QweDimsHelper] {ffffff}Используйте ' .. message_color_hex .. '/hlm [ID]', message_color)
		elseif settings.general.bind_leader_fastmenu and settings.general.use_binds and hotkey_no_errors then
			sampAddChatMessage('[QweDimsHelper] {ffffff}Используйте ' .. message_color_hex .. '/hlm [ID] {ffffff}или наведитесь на игрока через ' .. message_color_hex .. 'ПКМ + ' .. getNameKeysFrom(settings.general.bind_leader_fastmenu), message_color) 
		else
			sampAddChatMessage('[QweDimsHelper] {ffffff}Используйте ' .. message_color_hex .. '/hlm [ID]', message_color)
		end 
	end
...
function fast_heal_in_chat(id)
	if isMonetLoader() then
		sampAddChatMessage('[QweDimsHelper] {ffffff}Чтоб вылечить игрока ' .. sampGetPlayerNickname(id) .. ', в течении 5-ти секунд нажмите кнопку',message_color)
		...
		lua_thread.create(function() 
			...
			if heal_in_chat then
				...
				heal_in_chat = false
				sampAddChatMessage('[QweDimsHelper] {ffffff}Вы не успели вылечить игрока ' .. sampGetPlayerNickname(id), message_color)
			end
		end)
	elseif hotkey_no_errors and settings.general.use_binds then
		sampAddChatMessage('[QweDimsHelper] {ffffff}Чтобы вылечить игрока ' .. sampGetPlayerNickname(id) .. ' нажмите ' .. message_color_hex .. getNameKeysFrom(settings.general.bind_fastheal) .. ' {ffffff}в течении 5-ти секунд!',message_color)
		show_arz_notify('info', 'QweDimsHelper', 'Нажмите ' .. getNameKeysFrom(settings.general.bind_fastheal) .. ' чтобы быстро вылечить игрока', 5000)
		heal_in_chat_player_id = id
		lua_thread.create(function() 
			heal_in_chat = true
			wait(5000)
		...
		sampAddChatMessage('[QweDimsHelper] {ffffff}Ошибка, отсуствуют файлы библиотеки Mimgui Hotkeys!', message_color)
...
function sampev.onServerMessage(color,text)
	...
	if (settings.general.auto_uval and tonumber(settings.player_info.fraction_rank_number) >= 9) then
		...
		if text:find("(.+) заглушил%(а%) игрока (.+) на 1 минут. Причина: %[AutoUval%] Ожидайте...") and auto_uval_checker then
			...
			lua_thread.create(function ()
				wait(50)
				if Name == MyName then
					sampAddChatMessage('[QweDimsHelper] {ffffff}Увольняю игрока ' .. sampGetPlayerNickname(PlayerID) .. '!', message_color)
					auto_uval_checker = false
					temp = PlayerID .. ' ПСЖ'
					find_and_use_command("/uninvite {arg_id} {arg2}", temp)
				else
					sampAddChatMessage('[QweDimsHelper] {ffffff}Другой заместитель/лидер уже увольняет игрока ' .. sampGetPlayerNickname(PlayerID) .. '!', message_color)
					auto_uval_checker = false
				end
			end)
		end
	...
	if (text:find("У (.+) отсутствует трудовая книжка. Вы можете выдать ему книжку с помощью команды /givewbook") and tonumber(settings.player_info.fraction_rank_number) >= 9) then
		...
		sampAddChatMessage('[QweDimsHelper] {ffffff}У игрока ' .. nick .. ' нету трудовой книжки, выдайте её используя ' .. message_color_hex .. cmd .. ' ' .. sampGetPlayerIdByNickname(nick), message_color)
		return false
	end
	...
	if text:find('%(%( Чтобы принять вызов, введите /godeath (%d+). Оплата за вызов (.+) %)%)') then
		...
		if godeath_locate == 'неизвестном' then
			sampAddChatMessage('[QweDimsHelper] {ffffff}Из города ' .. message_color_hex .. godeath_city .. ' {ffffff}поступил вызов о пострадавшем ' .. message_color_hex .. sampGetPlayerNickname(godeath_player_id), message_color)
		else
			sampAddChatMessage('[QweDimsHelper] {ffffff}Из города ' .. message_color_hex .. godeath_city .. ' (' .. godeath_locate .. ') {ffffff}поступил вызов о пострадавшем ' .. message_color_hex .. sampGetPlayerNickname(godeath_player_id), message_color)
		end
		sampAddChatMessage('[QweDimsHelper] {ffffff}Чтобы принять вызов, используйте команду ' .. message_color_hex .. cmd .. ' '.. godeath_player_id, message_color)
		return false
	end
	...
	if text:find("Номера телефонов государственных служб:") then
		sampAddChatMessage('[QweDimsHelper] {ffffff}Номера телефонов государственных служб:', message_color)
		sampAddChatMessage('[QweDimsHelper] {ffffff}111 Баланс | 60 Время | 911 МЮ | 912 МЗ | 913 Такси | 914 Мехи | 8828 Банк | 997 Дома', message_color)
		return false
	end
...
function sampev.onShowDialog(dialogid, style, title, button1, button2, text)
	...
	if text:find("Проверьте и подтвердите данные перед выдачей мед карты") and text:find("Полностью здоров") then  -- автовыдача мед.карты
		sampAddChatMessage('[QweDimsHelper] {ffffff}Ожидайте пока игрок подтвердит получение мед. карты', message_color)
		sampSendDialogResponse(dialogid, 1,0,0)
		return false
	end
	...
	if title:find('Основная статистика') and check_stats then -- получение статистики
		if text:find("{FFFFFF}Имя: {B83434}%[(.-)]") then
			...
			sampAddChatMessage('[QweDimsHelper] {ffffff}Ваше Имя и Фамилия обнаружены, вы - ' .. settings.player_info.name_surname, message_color)
		end
		if text:find("{FFFFFF}Пол: {B83434}%[(.-)]") then
			settings.player_info.sex = text:match("{FFFFFF}Пол: {B83434}%[(.-)]")
			sampAddChatMessage('[QweDimsHelper] {ffffff}Ваш пол обнаружен, вы - ' .. settings.player_info.sex, message_color)
		end
		if text:find("{FFFFFF}Организация: {B83434}%[(.-)]") then
			...
			if settings.player_info.fraction == 'Не имеется' then
				sampAddChatMessage('[QweDimsHelper] {ffffff}Вы не состоите в организации!',message_color)
				settings.player_info.fraction_tag = "Неизвестно"
			else
				sampAddChatMessage('[QweDimsHelper] {ffffff}Ваша организация обнаружена, это: '..settings.player_info.fraction, message_color)
				...
				sampAddChatMessage('[QweDimsHelper] {ffffff}Вашей организации присвоен тег '..settings.player_info.fraction_tag .. ". Но вы можете изменить его.", message_color)
			end
		end
		if text:find("{FFFFFF}Должность: {B83434}(.+)%((%d+)%)") then
			...
			sampAddChatMessage('[QweDimsHelper] {ffffff}Ваша должность обнаружена, это: '..settings.player_info.fraction_rank.." ("..settings.player_info.fraction_rank_number..")", message_color)
			if tonumber(settings.player_info.fraction_rank_number) >= 9 then
			...
			sampAddChatMessage('[QweDimsHelper] {ffffff}Произошла ошибка, не могу получить ваш ранг!',message_color)
		end
		save_settings()
	...
	if members_check and title:find('(.+)%(В сети: (%d+)%)') then -- мемберс 
		...
		elseif #members_new ~= 0 then
			...
			sampSendDialogResponse(dialogid, 0, 0, 0)
			sampAddChatMessage('[QweDimsHelper]{ffffff} Список сотрудников пуст!', message_color)
			members_check = false
        end
        return false
    end
		...
		if id == 220 then
			...
			if raknetBitStreamReadInt8(bs) == 17 then
				...
				if cmd2:find('Основная статистика') and check_stats then -- /hme
					sampAddChatMessage('[QweDimsHelper] {ffffff}Ошибка, не могу получить данные из нового CEF диалога!', message_color)
					sampAddChatMessage('[QweDimsHelper] {ffffff}Включите старый (класичесский) вид диалогов в /settings - Кастомизация интерфейса', message_color)
    ...
    function(player)
		...
		if imgui.BeginTabBar('Tabs') then	
					...
					if settings.general.heal_in_chat then
						...
						if imgui.CenterColumnSmallButton(u8'Включить##heal_in_chat') then
							if not isMonetLoader() and not hotkey_no_errors then
								sampAddChatMessage('[QweDimsHelper] {ffffff}Ошибка, нельзя включить "Хил из чата" так как у вас нету Mimgui Hotkeys!', message_color)
							else
					...
					if settings.general.auto_uval then
						...
						if imgui.CenterColumnSmallButton(u8'Включить##auto_uval') then
							if tonumber(settings.player_info.fraction_rank_number) == 9 or tonumber(settings.player_info.fraction_rank_number) == 10 then 
								...
								settings.general.auto_uval = false
								sampAddChatMessage('[QweDimsHelper] {ffffff}Эта Функция доступна только лидеру и заместителям!',message_color)
							end
						end
					end
				imgui.EndChild()
			...
			if imgui.BeginTabItem(fa.MONEY_CHECK_DOLLAR..u8' Ценовая политика') then 
				...
				imgui.Separator()
				imgui.PushItemWidth(65 * MONET_DPI_SCALE)
				if imgui.InputText(u8'  Выдача мед.книжки', input_med60, 8) then
					settings.price.wbook = u8:decode(ffi.string(input_wbook))
					save_settings()
				end
			imgui.EndTabItem()
			end
			...
			if imgui.BeginTabItem(fa.GEAR..u8' Настройки') then 
				...
				imgui.Separator()
				imgui.Text(fa.CIRCLE_USER..u8" Разработчик данного хелпера: Gennadiy_Tkachuk 18")
				imgui.Separator()
				...
				imgui.SameLine()
				if imgui.SmallButton('Скоро будет!') then
					openLink(' ')
				end
				imgui.Separator()
				...
				imgui.Separator()
				imgui.Text(fa.GLOBE..u8" Тема хелпера в нашем Telegram канале:")
				imgui.SameLine()
				...
				imgui.SameLine()
				if imgui.SmallButton(u8'Тыкай сюда') then
				...
				if imgui.BeginPopupModal(fa.SACK_DOLLAR .. u8' Поддержка разработчика', _, imgui.WindowFlags.NoCollapse  + imgui.WindowFlags.NoResize ) then
					imgui.CenterText(u8'Привет спасибо конечно что ты нажал сюда\nНо не нужно донатить мне хватает :)')
					imgui.Separator()
				...
				-- imgui.TextWrapped(u8('Нашли баг или есть предложение по улучшению хелпера? Сообщите об этом на нашем Telegram канале'))
				imgui.CenterText(u8'Нашли баг или есть предложение по улучшению хелпера?')
				imgui.Separator()
				imgui.CenterText(u8'Сообщите об этом разработчику лично в Telegram')
				imgui.EndChild()
				...
				if imgui.BeginPopupModal(fa.TRIANGLE_EXCLAMATION .. u8' Предупреждение ##off', _, imgui.WindowFlags.NoResize ) then
					...
					if imgui.Button(fa.POWER_OFF .. u8' Да, выгрузить', imgui.ImVec2(200 * MONET_DPI_SCALE, 25 * MONET_DPI_SCALE)) then
						reload_script = true
						sampAddChatMessage('[QweDimsHelper] {ffffff}Хелпер приостановил свою работу до следущего входа в игру!', message_color)
						thisScript():unload()
					end
					imgui.End()
				end
				...
				if imgui.BeginPopupModal(fa.TRIANGLE_EXCLAMATION .. u8' Предупреждение ##delete', _, imgui.WindowFlags.NoResize ) then
					imgui.CenterText(u8'Вы действительно хотите удалить QweDimsHelper?')
					imgui.Separator()
					if imgui.Button(fa.CIRCLE_XMARK .. u8' Нет, отменить', imgui.ImVec2(200 * MONET_DPI_SCALE, 25 * MONET_DPI_SCALE)) then
						imgui.CloseCurrentPopup()
					end
...
imgui.OnFrame(
    ...
    function(player)
		imgui.SetNextWindowPos(imgui.ImVec2(sizeX / 2, sizeY / 2), imgui.Cond.FirstUseEver, imgui.ImVec2(0.5, 0.5))
		imgui.Begin(fa.HOSPITAL .. " QweDimsHelper - " .. fa.WALKIE_TALKIE .. u8" Рация депортамента", DeportamentWindow, imgui.WindowFlags.NoCollapse + imgui.WindowFlags.NoResize + imgui.WindowFlags.AlwaysAutoResize)
    ...
    function(player)
		...
		if imgui.Button(fa.ID_CARD_CLIP..u8" Выдать мед.карту", imgui.ImVec2(imgui.GetMiddleButtonX(1), 0)) then
					...
					lua_thread.create(function()
						...
						for line_index, line in ipairs(lines) do 
							if command_stop then 
								...
								sampAddChatMessage('[QweDimsHelper] {ffffff}Отыгровка команды /' .. command.cmd .. " успешно остановлена!", message_color) 
								return 
							end
							if wait_tag then
								for tag, replacement in pairs(tagReplacements) do
								...
								if line == "{pause}" then
									sampAddChatMessage('[QweDimsHelper] {ffffff}Команда /' .. command.cmd .. ' поставлена на паузу!', message_color)
									command_pause = true
									CommandPauseWindow[0] = true
									while command_pause do
										wait(0)
									...
									if not command_stop then
										sampAddChatMessage('[QweDimsHelper] {ffffff}Продолжаю отыгровку команды /' .. command.cmd, message_color)	
									end					
								else
									sampSendChat(line)
			...
			if not command_find then
				sampAddChatMessage('[QweDimsHelper] {ffffff}Бинд для выдачи мед.карты отсутствует либо отключён!', message_color)
				sampAddChatMessage('[QweDimsHelper] {ffffff}Попробуйте сбросить настройки хелпера!', message_color)
			end
			MedCardMenu[0] = false
		end
		imgui.End()
...
imgui.OnFrame(
    ...
    function(player)
		...
		if imgui.Button(fa.CAPSULES..u8" Выдать рецепты" , imgui.ImVec2(imgui.GetMiddleButtonX(1), 0)) then
			...
			if not command_find then
				sampAddChatMessage('[QweDimsHelper] {ffffff}Бинд для выдачи рецептов отсутствует либо отключён!', message_color)
				sampAddChatMessage('[QweDimsHelper] {ffffff}Попробуйте сбросить настройки хелпера!', message_color)
			end
			ReceptMenu[0] = false
		end
...
imgui.OnFrame(
    ...
    function(player)
		...
		if imgui.Button(fa.CAPSULES..u8" Выдать антибиотики" , imgui.ImVec2(imgui.GetMiddleButtonX(1), 0)) then
			...
			if not command_find then
				sampAddChatMessage('[QweDimsHelper] {ffffff}Бинд для выдачи антибиотиков отсутствует либо отключён!', message_color)
				sampAddChatMessage('[QweDimsHelper] {ffffff}Попробуйте сбросить настройки хелпера!', message_color)
			end
...
imgui.OnFrame(
    ...
    function(player)
		...
		if imgui.Button(fa.KEYBOARD .. u8' Бинд (для ПК)', imgui.ImVec2(imgui.GetMiddleButtonX(5), 0)) then
			sampAddChatMessage('[QweDimsHelper] {ffffff}Эта функция доступна только в платной версии 4.0 (покупать у MTG MODS)', -1)
		end
		imgui.SameLine()
			...
			if ffi.string(input_cmd):find('%W') or ffi.string(input_cmd) == '' or ffi.string(input_description) == '' or ffi.string(input_text) == '' then
				...
				for _, command in ipairs(temp_array) do
					if command.cmd == change_cmd and command.description == change_description and command.arg == change_arg and command.text:gsub('&', '\n') == change_text then
						...
						save_settings()
						if command.arg == '' then
							sampAddChatMessage('[QweDimsHelper] {ffffff}Команда ' .. message_color_hex .. '/' .. new_command .. ' {ffffff}успешно сохранена!', message_color)
						elseif command.arg == '{arg}' then
							sampAddChatMessage('[QweDimsHelper] {ffffff}Команда ' .. message_color_hex .. '/' .. new_command .. ' [аргумент] {ffffff}успешно сохранена!', message_color)
						elseif command.arg == '{arg_id}' then
							sampAddChatMessage('[QweDimsHelper] {ffffff}Команда ' .. message_color_hex .. '/' .. new_command .. ' [ID игрока] {ffffff}успешно сохранена!', message_color)
						elseif command.arg == '{arg_id} {arg2}' then
							sampAddChatMessage('[QweDimsHelper] {ffffff}Команда ' .. message_color_hex .. '/' .. new_command .. ' [ID игрока] [аргумент] {ffffff}успешно сохранена!', message_color)
						elseif command.arg == '{arg_id} {arg2} {arg3}' then
							sampAddChatMessage('[QweDimsHelper] {ffffff}Команда ' .. message_color_hex .. '/' .. new_command .. ' [ID игрока] [аргумент] [аргумент] {ffffff}успешно сохранена!', message_color)
						end
				...
				if not checker then
					sampAddChatMessage('[QweDimsHelper] {ffffff}ОШИБКА #787 ПРИ СОХРАНЕНИИ КОМАНДЫ ' .. message_color_hex .. '/' .. new_command .. ' {ffffff}!', message_color)
				end
				BinderWindow[0] = false
			end
		end
...
imgui.OnFrame(
    ...
    function(player)
		...
		if imgui.Button(fa.USER_DOCTOR..u8" Выдать ранг" , imgui.ImVec2(imgui.GetMiddleButtonX(1), 0)) then
					...
					lua_thread.create(function()
						...
						for _, line in ipairs(lines) do 
							...
							if wait_tag then
								...
								sampSendChat(line)
								if debug_mode then sampAddChatMessage('[QweDimsHelper DEBUG] Отправляю сообщение: ' .. line, message_color) end
			...
			if not command_find then
				sampAddChatMessage('[QweDimsHelper] {ffffff}Бинд для изменения ранга отсутствует либо отключён!', message_color)
				sampAddChatMessage('[QweDimsHelper] {ffffff}Попробуйте сбросить настройки хелпера!', message_color)
			end
...
imgui.OnFrame(
    ...
    function(player)
		imgui.SetNextWindowPos(imgui.ImVec2(sizeX / 2, sizeY / 2), imgui.Cond.FirstUseEver, imgui.ImVec2(0.5, 0.5))
		imgui.Begin(fa.HOSPITAL .. u8" QweDimsHelper - Оповещение##info_menu", _, imgui.WindowFlags.NoCollapse + imgui.WindowFlags.NoResize  + imgui.WindowFlags.AlwaysAutoResize  )
		...
		if imgui.Button(fa.CIRCLE_RIGHT..u8' Сбросить настройки ',  imgui.ImVec2(imgui.GetMiddleButtonX(2), 25 * MONET_DPI_SCALE)) then
			settings = default_settings
			save_settings()
			sampAddChatMessage('[QweDimsHelper] {ffffff}Настройки хелпера успешно сброшены! Перезагрузка...', message_color)
			reload_script = true
			thisScript():reload()
		end
		imgui.End()
...
imgui.OnFrame(
    ...
    function(player)
		if player_id ~= nil and isParamSampID(player_id) then
			...
			sampAddChatMessage('[QweDimsHelper] {ffffff}Прозиошла ошибка, ID игрока недействителен!', message_color)
			SobesMenu[0] = false
		end
...
function onScriptTerminate(script, game_quit)
    if script == thisScript() and not game_quit and not reload_script then
		sampAddChatMessage('[QweDimsHelper] {ffffff}Произошла неизвестная ошибка, хелпер приостановил свою работу!', message_color)
		if not isMonetLoader() then 
			sampAddChatMessage('[QweDimsHelper] {ffffff}Используйте ' .. message_color_hex .. 'CTRL {ffffff}+ ' .. message_color_hex .. 'R {ffffff}чтобы перезапустить хелпер.', message_color)
		end
